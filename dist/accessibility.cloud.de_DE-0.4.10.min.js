(function(b,c){'object'==typeof exports&&'object'==typeof module?module.exports=c():'function'==typeof define&&define.amd?define([],c):'object'==typeof exports?exports['accessibility.cloud']=c():b['accessibility.cloud']=c()})(this,function(){return function(a){function b(d){if(c[d])return c[d].exports;var f=c[d]={i:d,l:!1,exports:{}};return a[d].call(f.exports,f,f.exports,b),f.l=!0,f.exports}var c={};return b.m=a,b.c=c,b.i=function(d){return d},b.d=function(d,f,g){b.o(d,f)||Object.defineProperty(d,f,{configurable:!1,enumerable:!0,get:g})},b.n=function(d){var f=d&&d.__esModule?function(){return d['default']}:function(){return d};return b.d(f,'a',f),f},b.o=function(d,f){return Object.prototype.hasOwnProperty.call(d,f)},b.p='',b(b.s=5)}([function(a,b,c){'use strict';function d(u){return o()(u).replace(/^Rating /,'')}function f(u){return!0===u?'Ja':!1===u?'Nein':u}function g(u){const v=Math.floor(5*Math.min(1,Math.max(0,u))),w='\u2605\u2605\u2605\u2605\u2605'.slice(5-v);return`<span class="stars">${w}</span> <span class="numeric">${v}/5</span>`}function h(u){if($.isArray(u))return`<ul class="ac-list">${u.map(v=>`<li>${h(v)}</li>`).join('')}</ul>`;if($.isPlainObject(u)){const v=$.map(u,(w,x)=>{return $.isArray(w)||$.isPlainObject(w)?'areas'===x&&1===w.length?h(w[0]):`<li class="ac-group"><header class='subtle'>${d(x)}</header> ${h(w)}</li>`:x.startsWith('rating')?`<li class="ac-rating">${d(x)}: ${g(parseFloat(w))}</li>`:`<li class="ac-${typeof w}">${d(x)}: <span class='value'>${f(w)}</span></li>`});return`<ul class="ac-group">${v.join('')}</ul>`}return u}function k(u){return u.accessibility&&u.accessibility.accessibleWith&&u.accessibility.accessibleWith.wheelchair}var l=c(4),m=c.n(l),n=c(3),o=c.n(n),p=c(1);c.n(p),Object.defineProperty(b,'__esModule',{value:!0});const q={apiDomain:'https://www.accessibility.cloud',getPlacesAround(u){return $.ajax({dataType:'json',url:`${this.apiDomain}/place-infos?includeRelated=source`,data:u,headers:{Accept:'application/json','X-Token':this.token}})},resultsTemplate(){return`<ul class="ac-result-list" role="treegrid"> \
      {{#places}} \
        {{#properties}} \
