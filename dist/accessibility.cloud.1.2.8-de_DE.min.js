(function(b,c){'object'==typeof exports&&'object'==typeof module?module.exports=c():'function'==typeof define&&define.amd?define([],c):'object'==typeof exports?exports['accessibility.cloud']=c():b['accessibility.cloud']=c()})(this,function(){return function(a){function b(d){if(c[d])return c[d].exports;var f=c[d]={i:d,l:!1,exports:{}};return a[d].call(f.exports,f,f.exports,b),f.l=!0,f.exports}var c={};return b.m=a,b.c=c,b.i=function(d){return d},b.d=function(d,f,g){b.o(d,f)||Object.defineProperty(d,f,{configurable:!1,enumerable:!0,get:g})},b.n=function(d){var f=d&&d.__esModule?function(){return d['default']}:function(){return d};return b.d(f,'a',f),f},b.o=function(d,f){return Object.prototype.hasOwnProperty.call(d,f)},b.p='',b(b.s=7)}([function(a,b,c){'use strict';function d(v,w){const x=w[`${v}Localized`]||v;return o()(x).replace(/^Rating /,'')}function f(v){return!0===v?q`Yes`:!1===v?q`No`:v}function g(v){const w=Math.floor(5*Math.min(1,Math.max(0,v))),x='\u2605\u2605\u2605\u2605\u2605'.slice(5-w);return`<span class="stars">${x}</span> <span class="numeric">${w}/5</span>`}function h(v){if($.isArray(v))return`<ul class="ac-list">${v.map(w=>`<li>${h(w)}</li>`).join('')}</ul>`;if($.isPlainObject(v)){const w=$.map(v,(x,y)=>{if(y.match(/Localized/))return'';const z=d(y,v);return $.isArray(x)||$.isPlainObject(x)?'areas'===y&&1===x.length?h(x[0]):`<li class="ac-group"><header class='subtle'>${z}</header> ${h(x)}</li>`:y.startsWith('rating')?`<li class="ac-rating">${z}: ${g(parseFloat(x))}</li>`:`<li class="ac-${typeof x}">${z}: <span class='value'>${f(x)}</span></li>`});return`<ul class="ac-group">${w.join('')}</ul>`}return v}function k(v){return v.accessibility&&v.accessibility.accessibleWith&&v.accessibility.accessibleWith.wheelchair}var l=c(6),m=c.n(l),n=c(5),o=c.n(n),p=c(3);c.n(p),c(1),Object.defineProperty(b,'__esModule',{value:!0});const q=p.t,u={getLocale(){return'de_DE'},apiDomain:'https://www.accessibility.cloud',getPlacesAround(v){return $.ajax({dataType:'json',url:`${this.apiDomain}/place-infos?includeRelated=source&locale=${this.getLocale()}`,data:v,headers:{Accept:'application/json','X-Token':this.token}})},resultsTemplate(){return`<ul class="ac-result-list" role="treegrid"> \
      {{#places}} \
        {{#properties}} \
